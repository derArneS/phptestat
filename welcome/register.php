        ...
        <div class="col-md-9 col-lg-8 mx-auto">
          ...
          <form>
            <div class="form-label-group">
              <input type="benutzername" id="inputBenutzername" class="form-control" placeholder="Benutzername" required autofocus>
            ...
            <div class="form-label-group">
              <input type="password2" id="inputPassword2" class="form-control" placeholder="Passwort wiederholen" required>
